...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'MyContigFilter'):
...
impl_MyContigFilter = MyContigFilter(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['MyContigFilter.filter_contigs_async'] = ['MyContigFilter', 'filter_contigs']
async_check_methods['MyContigFilter.filter_contigs_check'] = ['MyContigFilter', 'filter_contigs']
sync_methods['MyContigFilter.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'MyContigFilter'
        ...
        self.rpc_service.add(impl_MyContigFilter.filter_contigs,
                             name='MyContigFilter.filter_contigs',
                             types=[dict])
        self.method_authentication['MyContigFilter.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "MyContigFilter but no authentication header was passed"
                            raise err
